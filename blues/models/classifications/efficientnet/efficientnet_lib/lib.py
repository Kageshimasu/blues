...
# **Efficient-Net Code from this github repo: https://github.com/lukemelas/EfficientNet-PyTorch**
...
class CNN_Model(nn.Module):
    def __init__(self, model_name='efficientnet-b5', global_dim=2048):
        super(CNN_Model, self).__init__()

        self.cnn_backbone = Model.from_name(model_name)
        self.cnn_backbone.set_swish(memory_efficient=False)

        self.cnn_head_grapheme_root = CNN_Head(168, global_dim, 1024, 512)
        self.cnn_head_vowel_diacritic = CNN_Head(11, global_dim, 1024, 512)
        self.cnn_head_consonant_diacritic = CNN_Head(7, global_dim, 1024, 512)
...
class CNN_Head(nn.Sequential):
    def __init__(self, classes, input_dim, linear1_output_dim, linear2_output_dim,
                 ...
                 global_dropout=0.0, lin1_dropout=0.0, lin2_dropout=0.00):
